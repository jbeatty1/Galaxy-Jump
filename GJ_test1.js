...
function preload ()
{
    ...
    this.load.image('star', 'assets/images/star.png'); // used
    ...
    this.load.tilemapTiledJSON('map', 'assets/courses/tiletest2.json');
}
...
function create ()
{
    ...
    kickCollider = this.physics.add.overlap(pHitboxes, blocks, null, rebound, this);
...
function update (time, delta)
{
    ...
    if (!sideKick || tickCount >= ticksToKickEnd || player.body.onFloor())
    {
        sideKick = false;
    ...
    text2.setText(' XAcc: ' + player.body.acceleration.x + " \nkickAgain: " + kickAgain + " sideKick: " + sideKick + " lastKick_V: " + lastKick_V
        ...
        + " \nenable: " + sideKickBox.body.enable  + ' collided: ' + collision
...
function rebound(pHitboxes, tile)
{
