...
export default class Player extends Phaser.Physics.Arcade.Sprite {
    ...
    update(time, delta) {
        ...
        if (this.crouching) {
            ...
            console.log("OffsetY after size change: " + this.body.offset.y);
            if (!this.sliding) {
                console.log("Crouch offset");
                this.body.setOffset(this.P_X_OFFSET, this.P_HEIGHT - this.P_HCROUCH);
                // console.log("New offsetY: " + this.body.offset.y);
            }
        ...
        // else if (!this.solids.getTileAtWorldXY(this.body.position.x, this.body.position.y + this.P_HEIGHT, true).collideDown) {
            ...
            console.log(this.crouching);
            this.body.setSize(this.P_HITBOX_W, this.P_HITBOX_H, true);  
        ...
        /** Idle animation */
        if (!this.isAttacking() && !this.isJumping && this.cursors.left.isUp && this.cursors.right.isUp && !this.crouching){
    ...
    alignPlayerKick() {
        ...
        if (this.xFacing == this.xDirection.RIGHT || this.kickDirection == this.xDirection.RIGHT) {
            ...
            // console.log("KICK: New offsetY: " + this.body.offset.y);
        }
